...
$(document).ready(function(){
	...
	$('#btn_NovaSanf').click(function(){ 
        ...
        "<tr><td>ENTRADA.: *</td><td><input type='text' name='edtEntrada' value=''></td></tr>"+
        "<tr><td>CLIENTE: *</td><td><input type='text' name='edtCliente' value=''></td></tr>"+
        "<tr><td>MODELO: *</td><td><input type='text' name='edtModelo' value=''></td></tr>"+
        ...
        "<tr><td>PREVISÃO: </td><td><input type='text' name='edtPrevisao' value='0'></td></tr>"+
        "<tr><td>OBSERVAÇÃO: </td><td><input type='text' name='edtObs' value='0'></td></tr>"+
        "</table></form>"; 
